...
Module="PatientStudy"
	...
	Sequence="AdmittingDiagnosesCodeSequence"	Type="3"	VM="1-n"
		InvokeMacro="CodeSequenceMacro"
	SequenceEnd
	Sequence="PrincipalDiagnosisCodeSequence"	Type="3"	VM="1"
		InvokeMacro="CodeSequenceMacro"
	SequenceEnd
	Sequence="PrimaryDiagnosisCodeSequence"		Type="3"	VM="1"
		InvokeMacro="CodeSequenceMacro"
	SequenceEnd
	Sequence="SecondaryDiagnosesCodeSequence"	Type="3"	VM="1-n"
		InvokeMacro="CodeSequenceMacro"
	SequenceEnd
	Sequence="HistologicalDiagnosesCodeSequence"	Type="3"	VM="1-n"
		InvokeMacro="CodeSequenceMacro"
	SequenceEnd
...
Module="ImagePixel"
	InvokeMacro="ImagePixelDescriptionMacro"
	Verify="ICCProfile"										Condition="ICCProfileAndOpticalPathSequencePresent"		ThenErrorMessage="Shall not be present when OpticalPathSequence is present"
	Verify="ColorSpace"										Condition="ColorSpaceAndOpticalPathSequencePresent"		ThenErrorMessage="Shall not be present when OpticalPathSequence is present"
...
Module="MicroscopeSlideLayerTileOrganization"
	...
	Name="TilesOverlap"									Type="3"	StringEnumValues="TilesOverlap"
	Verify="TilesOverlap"											Condition="TilesOverlapPresentAndTILED_FULL"	StringEnumValues="TilesOverlapNONE"
ModuleEnd
...
Module="OpticalPath"
	...
	Sequence="OpticalPathSequence"						Type="1"	VM="1-n"
		...
		Name="ColorSpace"								Type="3"
	SequenceEnd
	Verify="OpticalPathSequence"									Condition="UnwantedOpticalPathAndICCProfileModules"	ThenErrorMessage="Optical Path Module shall not be present for VL Microscopic Image IOD or VL Slide-Coordinates Microscopic Image IOD when ICC Profile Module is present"
ModuleEnd
...
Module="ICCProfile"
	...
	Verify="ICCProfile"													Condition="UnwantedOpticalPathAndICCProfileModules"	ThenErrorMessage="ICC Profile Module shall not be present for VL Microscopic Image IOD or VL Slide-Coordinates Microscopic Image IOD when Optical Path Module is present"
	Name="ColorSpace"										Type="3"
ModuleEnd
